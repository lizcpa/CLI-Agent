...
- [架构设计 V4.1](doc/architecture_v4.1.md)
- [开发计划](doc/development_plan.md)
- [部署指南](doc/deployment_guide.md)
- [可观测性](doc/observability.md)
- [安全设计](doc/security.md)
- [生产环境检查清单](doc/production_checklist.md)
...
- 异步任务返回 `task_id`，通过 `query_task_status` 轮询
- 服务间通信携带 JWT + `X-Tenant-ID`
- 健康检查路由统一由 `common_sdk.health.build_health_router` 生成
- Prometheus 指标统一由 `common_sdk.metrics.setup_metrics` 注册
